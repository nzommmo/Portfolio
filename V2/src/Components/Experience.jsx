    ...
    <div>
        {Experiences.map((Experience,index)=>(
                    ...
                    <li className='mb-12'>
                        ...
                        <div className='z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2'>{Experience.Period}</div>
                        <div className='z-10 sm:col-span-6'>
                            ...
                            <div>
                                ...
                                <span className=''>{Experience.Title} · <span className='inline-block'>{Experience.Company}
